...
To modify in any way:
    1. go to the GitHub repo and fork the project
        a. get coding and make a great mod, who knows it may become a part of the project.

The code is in [gui.py]
All dependency other than python are included and are located in [libraries].
All themes are in [assets] along with other images.
